...
```cmake (ILI9341)
cmake -DILI9341=ON -DGPIO_TFT_DATA_CONTROL=24 -DGPIO_TFT_RESET_PIN=25 -DGPIO_TFT_BACKLIGHT=23 -DSPI_BUS_CLOCK_DIVISOR=30 -DSTATISTICS=0 -DBACKLIGHT_CONTROL=ON ..
```

```cmake (ILI9488)
cmake -DILI9488=ON -DGPIO_TFT_DATA_CONTROL=24 -DGPIO_TFT_RESET_PIN=25 -DGPIO_TFT_BACKLIGHT=23 -DSPI_BUS_CLOCK_DIVISOR=30 -DSTATISTICS=0 -DBACKLIGHT_CONTROL=ON ..
```
